...
class Upload
{
    ...
    function init()
    {
        ...
        $this->forbidden = array_merge($this->dangerous, [
            'exe',
            'dll',
        ]);
                    ...
                    switch ($this->image_src_type) {
                        ...
                        case 'webp':
                            if (! $this->function_enabled('imagecreatefromwebp')) {
                                $this->processed = false;
                                $this->error = $this->translate('no_create_support', ['WEBP']);
                            } else {
                                $image_src = @imagecreatefromwebp($this->file_src_pathname);
                                if (! $image_src) {
                                    $this->processed = false;
                                    $this->error = $this->translate('create_error', ['WEBP']);
                                } else {
                ...
                if ($this->processed && $image_src) {
                    ...
                    if ($this->image_watermark != '' && file_exists($this->image_watermark)) {
                        ...
                        if ($watermark_type == IMAGETYPE_GIF) {
                            ...
                            if (! $this->function_enabled('imagecreatefromwebp')) {
                                $this->error = $this->translate('watermark_no_create_support', ['WEBP']);
                            } else {
                                $filter = @imagecreatefromwebp($this->image_watermark);
                                if (! $filter) {
                                    $this->error = $this->translate('watermark_create_error', ['WEBP']);
                                } else {
                    ...
                    switch ($this->image_convert) {
                        ...
                        case 'webp':
                            ...
                            if (! $result) {
                                $this->processed = false;
                                $this->error = $this->translate('file_create', ['WEBP']);
                            } else {
