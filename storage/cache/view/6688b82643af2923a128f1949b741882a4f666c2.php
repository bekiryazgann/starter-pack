<aside class="w-[300px] border-r border-r-zinc-200 h-screen fixed top-0 left-0 flex flex-col justify-between">
    <div class="sticky top-0 z-40 bg-gray-0/10 px-6 pb-5 pt-5 dark:bg-gray-100/5 2xl:px-8 2xl:pt-6 h-[90px] border-b border-b-zinc-200">
        <a href="<?php echo e(site('admin')); ?>" class="flex items-center justify-start h-full">
    ...
    <div class="flex-1 overflow-hidden">
        <?php if ($__env->exists('admin.layout.menu')) echo $__env->make('admin.layout.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <div class="px-4 py-6 border-t border-t-zinc-200 flex items-start justify-between max-h-[90px] h-[90px]">
        ...
        <div>
            <a class="block" href="<?php echo e(site('admin/auth/login')); ?>">
                <i class="icon-log-out-01 text-gray-700 text-[20px]"></i>
            </a>
        </div>
    </div>
</aside><?php /**PATH /Users/bekir/Desktop/projects/starter-pack/public/view/admin/layout/aside.blade.php ENDPATH**/ ?>