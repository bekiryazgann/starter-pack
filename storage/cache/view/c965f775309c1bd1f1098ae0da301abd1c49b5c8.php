        ...
        <div class="grow shrink basis-0 pr-8 justify-start items-start gap-4 flex p-">
            ...
            <div class="grow shrink basis-0 pt-0.5 flex-col justify-start items-start gap-3 inline-flex">
                <div class="self-stretch flex-col justify-start items-start gap-1 flex">
                    <div class="self-stretch text-gray-900 text-sm font-semibold leading-tight"><?php echo $message->title; ?></div>
                    <div class="self-stretch text-slate-700 text-sm font-normal leading-tight"><?php echo $message->message; ?></div>
                </div>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH /Users/bekir/Desktop/projects/starter-pack/public/view/admin/layout/alert.blade.php ENDPATH**/ ?>